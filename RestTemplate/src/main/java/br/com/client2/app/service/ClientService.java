...
public class ClientService {
	...
	/**
	 * 
	 * O usario pode ser o usuario/senha logado ou usuario/senha sistema em um arquivo properties
	 * 
	 * @param codigo
	 * @return
	...
	public String consomeClientBasicAuth(Integer codigo) throws ServiceException, ServiceNoContentExcetion {
		...
		return consomeClientRestTemplate.authorizationRestTemplate(urlFormt,usuario,senha);
	}
}
