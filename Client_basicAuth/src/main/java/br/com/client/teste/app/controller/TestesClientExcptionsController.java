...
public class TestesClientExcptionsController {
	...
	@Operation(summary = "BASIC AUTHENTICATION - GET", description = "http://localhost:8081/client/swagger-ui/index.html", tags = {
	...
	@Operation(summary = "BASIC AUTHENTICATION - GET", description = "BUSCAR CODIGO EXCPTIONS", tags = {
